...
public class PaieUtilsTest {
	...
	@Test
	public void test_formaterBigDecimal_5_chiffres_après_la_virgule() {
		String resultat = paieUtils.formaterBigDecimal(new BigDecimal("6.12587"));
		assertThat(resultat, equalTo("6.13"));
	}
